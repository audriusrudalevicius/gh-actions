...
const render = __importStar(__nccwpck_require__(9089));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = yield render.Render(templatePath, dataPath, templatesDir);
            if (core.isDebug()) {
...
function Render(templatePath, dataPath, templatesDir) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cfg = Object.assign(Object.assign({}, eta_1.defaultConfig), {
            autoTrim: false
        });
        return yield (0, eta_1.renderAsync)(tpl.toString(), JSON.parse(data.toString()), cfg);
    });
}
